...
<body> 
    ...
    if(mysqli_num_rows($res)>0){ ?>
        <table>
                ...
                <td><?php echo "ID: " ; echo $row["vehicle_id"]; echo "<br>REG. PLATE: ";echo $row["vehicle_reg"]; echo "<br>BRAND: ";echo $row["brand"]; echo "<br>MODEL: ";echo $row["model"]; echo "<br>TYPE: "; echo $row["type"];  echo "<br>DESCRIPTION: "; echo $row["description"]; /*echo "<br>STATUS: ";
                if($row["status"]==1){
                    echo "Available";
                }
                else
